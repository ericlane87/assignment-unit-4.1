...
function isFirstLetter(letter, str) {
  return str.charAt(0).toLowerCase() === letter.toLowerCase();

}
console.log(isFirstLetter( "t","test"))
...
let testpositivenum = [1,2,3,-5,-6]
console.log(allPositive(testpositivenum))
